...
def init(
    ...
    enhancement_lines = [
        ...
        f"○ [cyan]/personas.checklist[/] [bright_black](optional)[/bright_black] - Generate quality checklists to validate requirements completeness, clarity, and consistency (after [cyan]/personas.design[/])"
    ]
